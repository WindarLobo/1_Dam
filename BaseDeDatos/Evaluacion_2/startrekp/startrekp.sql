...
drop table if exists humanos cascade ;
drop table if exists interpretespel cascade;
drop table if exists interpretesser cascade;
drop table if exists klingon cascade ;
drop table if exists lanzaderas cascade;
drop table if exists naves cascade ;
drop table if exists peliculas cascade;
drop table if exists personaxes cascade;
drop table if exists planetas cascade ;
drop table if exists visitas cascade ;
drop table if exists vulcanos cascade;
...
CREATE TABLE personaxes 
    ( 
     codper varchar (3)  NOT NULL ,
     nomper varchar (15) unique ,  
...
CREATE TABLE planetas 
    ( 
     codpla varchar (5)  NOT NULL , 
     nompla varchar (10)  NOT NULL , 
     galaxia varchar (10) ,
     PRIMARY KEY ( codpla ) 
    );
...
insert into interpretespel values('a1','p1','pel1','n',100);
insert into interpretespel values('a1','p1','pel2','n',80);
insert into interpretespel values('a1','p1','pel3','n',70);
...
insert into interpretespel values('a9','p12','pel5','n',50);
insert into interpretespel values('a9','p16','pel5','n',2);
...
insert into interpretespel values('a17','p1','pel5','n',100);
insert into interpretespel values('a17','p1','pel4','n',100);
